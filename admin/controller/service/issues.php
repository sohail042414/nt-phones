...
class ControllerServiceIssues extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('service/issue', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['delete'] = $this->url->link('catalog/issues/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		// $data['sort_model'] = $this->url->link('service/issues', 'user_token=' . $this->session->data['user_token'] . '&sort=p.model' . $url, true);
		// $data['sort_price'] = $this->url->link('service/issues', 'user_token=' . $this->session->data['user_token'] . '&sort=p.price' . $url, true);
		// $data['sort_quantity'] = $this->url->link('service/issues', 'user_token=' . $this->session->data['user_token'] . '&sort=p.quantity' . $url, true);
		// $data['sort_status'] = $this->url->link('service/issues', 'user_token=' . $this->session->data['user_token'] . '&sort=p.status' . $url, true);
		// $data['sort_order'] = $this->url->link('service/issues', 'user_token=' . $this->session->data['user_token'] . '&sort=p.sort_order' . $url, true);
